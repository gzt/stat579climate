...
\begin{figure}[H]
<<chunk2, dependson='initial', cache=TRUE, message=FALSE, echo=FALSE, fig.width=8, fig.height=8, out.width='\\linewidth'>>=
suppressMessages(library(ggplot2))
...
<<plot-trend, dependson='initial', message=FALSE, echo=FALSE, fig.width=5, fig.height=3, out.width='\\linewidth'>>=
suppressMessages(library(ggplot2))
...
<<15-years, dependson='initial', message=FALSE, echo=FALSE, fig.width=5, fig.height=3, out.width='\\linewidth'>>=
suppressMessages(library(ggplot2))
...
<<recent-trend, dependson='initial', message=FALSE, echo=FALSE, fig.width=5, fig.height=3,out.width='\\linewidth'>>=
suppressMessages(library(ggplot2))
...
<<story-trend, dependson='initial', message=FALSE, echo=FALSE, fig.width=5, fig.height=3,out.width='\\linewidth'>>=
suppressMessages(library(ggplot2))
...
<<augsburg-trend, dependson='initial', message=FALSE, echo=FALSE, fig.width=6, fig.height=4, out.width='\\linewidth'>>=
suppressMessages(library(ggplot2))
...
<<antartic-trend, dependson='initial', message=FALSE, echo=FALSE, fig.width=6, fig.height=4, out.width='\\linewidth'>>=
suppressMessages(library(ggplot2))
...
<<1978-map, dependson='initial', cache=TRUE, message=FALSE, echo=FALSE, fig.width=8, fig.height=5, out.width='\\linewidth'>>=
suppressMessages(library(ggplot2))
...
<<1997-map, dependson='initial', cache=TRUE, message=FALSE, echo=FALSE, fig.width=8, fig.height=5, out.width='\\linewidth'>>=
suppressMessages(library(ggplot2))
sep2012<-subset(annual,realyear==1997)
